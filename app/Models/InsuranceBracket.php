...
class InsuranceBracket extends Model
{
    ...
    protected $fillable = [
        ...
        'health_employee',
        'health_employer',
        'occupational_employee',
        'occupational_employer',
        'labor_pension_6_percent',
        'pension_employer',
    ];
    ...
    protected $casts = [
        ...
        'occupational_employee' => 'integer',
        'occupational_employer' => 'integer',
        'labor_pension_6_percent' => 'integer',
